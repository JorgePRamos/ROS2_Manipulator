...
: ${AMENT_CURRENT_PREFIX:="/ROS2_Manipulator/ubot_ws/install/cpp_samples"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_samples/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_samples/environment/path.sh"
